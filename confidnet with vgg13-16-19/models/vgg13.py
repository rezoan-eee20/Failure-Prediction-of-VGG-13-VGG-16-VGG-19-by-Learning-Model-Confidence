...
class VGG13(AbstractModel):
    ...
    def init_vgg13_params(self):
        vgg13 = models.vgg13(pretrained=True).to(self.device)
        vgg_layers = []
        for _layer in vgg13.features.children():
